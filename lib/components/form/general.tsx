...
type FormProps = {
    scheme: Schema[]
    labelPosition?: 'column' | 'left' | 'right'
    ...
    return(
       <React.Fragment>
         { Object.keys(state).map((keyName, index)=> {
            ...
            if(element) {
                element.onChange =(value)=> useChangeValue(keyName, value);
                if(labelPosition) element.position = labelPosition;
            }
